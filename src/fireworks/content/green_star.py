...
def seed_green_star(world: EpistemicWorldRepository) -> None:
    ...
    if not _relation_exists(world, "core.contains", FIREWORKS_CITY_ID, GREEN_STAR_ID):
        world.add_relation("core.contains", FIREWORKS_CITY_ID, GREEN_STAR_ID)
    if not _relation_exists(world, "core.contains", GREEN_STAR_ID, GREEN_STAR_MAIN_BAR_ID):
        world.add_relation("core.contains", GREEN_STAR_ID, GREEN_STAR_MAIN_BAR_ID)
    if not _relation_exists(world, "core.contains", GREEN_STAR_ID, GREEN_STAR_RESTROOM_ID):
